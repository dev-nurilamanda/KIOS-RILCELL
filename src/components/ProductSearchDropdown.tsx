      ...
      {mode === 'dropdown' ? (
        <div>
          ...
          <button
            ...
            className={`w-full flex items-center justify-between gap-2.5 px-3.5 sm:px-4 py-3 sm:py-3.5 rounded-xl text-left transition-all duration-150 cursor-pointer ${
              error
        ...
        <div className="space-y-1">
          <div className="relative">
            <input
              ...
              className="w-full bg-slate-50 border border-slate-300 rounded-xl px-4 py-3 sm:py-3.5 pr-24 text-sm sm:text-base font-bold text-slate-900 focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 focus:outline-none placeholder:font-normal placeholder:text-xs sm:placeholder:text-sm"
            />
            ...
            <div className="absolute right-2 top-2 sm:top-2.5 flex items-center gap-1">
              <button
                type="button"
                onClick={handleSwitchToDropdown}
                className="px-2.5 py-1.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 font-bold text-xs rounded-lg border border-emerald-200 flex items-center gap-1 transition shadow-2xs cursor-pointer"
